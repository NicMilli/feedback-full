  ...
  return (
    <Card>
      <div className="about">
        ...
        <p>Version 2.0.0</p>
        <p>
          <a target='_blank' rel='noreferrer noreopener' href="https://github.com/NicMilli/feedback-full" className='noUnder'> 
          <FaGithub/> &nbsp; View the source code! 
          </a>
          <br />
          <Link to='/' className='noUnder'> 
            <FaHome/> &nbsp; Back to the Feedabck app
          </Link>
        </p>
      </div>
